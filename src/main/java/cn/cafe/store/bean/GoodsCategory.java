...
public class GoodsCategory implements Serializable{
	...
	public GoodsCategory(Integer id, Integer parentId, String name, Integer status, Integer isParent, Date createdTime,
	...
	public String toString() {
		return "GoodsCategory [id=" + id + ", parentId=" + parentId + ", name=" + name + ", status=" + status
				+ ", isParent=" + isParent + ", createdTime=" + createdTime + ", modifiedTime=" + modifiedTime
